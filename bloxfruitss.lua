...
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/x2zu/OPEN-SOURCE-UI-ROBLOX/refs/heads/main/X2ZU%20UI%20ROBLOX%20OPEN%20SOURCE/NewUiStellar.lua")))();
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("Stellar/Blox Fruits/") then
			makefolder("Stellar/Blox Fruits/");
		end;
		if not isfile(("Stellar/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Stellar/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Stellar/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
	...
	if Update:SaveSettings() then
		if readfile and writefile and isfile and isfolder then
			if not isfile(("Stellar/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
				...
				writefile("Stellar/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
			end;
		else
			return warn("Status : Undetected Executor");
		end;
